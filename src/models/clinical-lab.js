...
const clinicalLabSchema = mongoose.Schema({
    ...
    location: {
        ...
        district: {
            type: String,
            required: [true, "Clinical lab's location's district is required"],
        },
        pincode: {
            type: Number,
            required: [true, "Clinical lab's location's pincode is required"],
        },
        state: {
            type: String,
        ...
        country: {
            type: String,
            required: [true, "Clinical lab's location's country is required"],
        },
        coords: {
            // lat: {
            //     type: Number,
